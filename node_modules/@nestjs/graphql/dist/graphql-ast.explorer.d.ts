...
export declare class GraphQLAstExplorer {
    ...
    lookupDefinition(item: Readonly<TypeSystemDefinitionNode>, tsFile: SourceFile, mode: 'class' | 'interface', options: DefinitionsGeneratorOptions): void;
    ...
    addObjectTypeDefinition(item: ObjectTypeDefinitionNode | InputObjectTypeDefinitionNode | InterfaceTypeDefinitionNode, tsFile: SourceFile, mode: 'class' | 'interface', options: DefinitionsGeneratorOptions): void;
